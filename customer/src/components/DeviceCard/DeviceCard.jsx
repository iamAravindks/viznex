  ...
  return (
    <div className="w-[clamp(200px,78%,250px)] bg-white shadow-[0_0_68px_rgba(0,0,0,0.25)] rounded-[10px] min-h-[251px] ">
      <div
        ...
        style={{
          background: "linear-gradient(94.26deg, #5940F5 -1.67%, #6FBFE8 100%)",
        }}
      >
        <p className="text">Device 1</p>
      </div>
      <div className="location flex flex-col items-center mt-12 text-center">
