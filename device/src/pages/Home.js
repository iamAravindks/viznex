...
const Home = () => {
      ...
      if (currentUrlIndex < val - 1) {
        ...
        do {
          if (newInfo.slots[slot].queue[nextIndex].datesPlayed != undefined) {
            newInfo.slots[slot].queue[nextIndex].adFrequency =
              newInfo.slots[slot].queue[nextIndex].adFrequency -
              newInfo.slots[slot].queue[nextIndex].datesPlayed[0]
          ...
          newInfo.slots[slot].queue[nextIndex].datesPlayed != undefined &&
          newInfo.slots[slot].queue[nextIndex].adFrequency ===
            newInfo.slots[slot].queue[nextIndex].datesPlayed[0]
              .noOfTimesPlayedOnDate
        );
  ...
  return (
    <div className="relative">
      {slot !== null &&
        info.slots[slot] &&
        info.slots[slot].queue[currentUrlIndex] &&
        info.slots[slot].queue[currentUrlIndex].ad && (
          <div className="">
            <ReactPlayer
              ref={videoRef}
              playing={true}
              ...
              onEnded={() =>
                handleEnded(
                  info.slots[slot].queue.length,
                  info._id,
                  info.slots[slot].name,
                  info.slots[slot].queue[currentUrlIndex].ad._id,
                  info.slots[slot].queue[currentUrlIndex].operator._id
                )
              }
            />
          </div>
